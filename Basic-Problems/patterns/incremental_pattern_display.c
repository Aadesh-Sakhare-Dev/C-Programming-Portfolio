 ...
 *   displays a pattern where each row contains '*' and '#' characters. The
 *   number of '*' characters increases from left to right as you move down the
 *   rows, and the remaining characters in each row are '#'.
 * Example:
 * Input : iRow = 4    iCol = 4
 * Output:
 * *   #   #   #
 ...
 *                  replaces '#' with '*' from left to right as you move down
 *                  the rows.
