 ...
 *   displays a pattern of '*' and '@' characters. The pattern displays '*' 
 *   on the borders and '@' in the inner area, except for the border rows 
 *   and columns.
 * Example:
 * Input : iRow = 6    iCol = 5
 * Output:
 ...
 *                  has '*' on the borders and '@' in the inner area.
